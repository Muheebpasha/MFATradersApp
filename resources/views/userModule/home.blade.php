...
@section('content')
        ...
        <section class="hero hero-slider-wrapper">
            <div class="hero-slider hero-slider-style-1">
                <div class="slide">
                    <img src="{{ asset('media/frontend/images/slider/slide-2.jpg') }}" alt class="slider-bg">
                    <div class="container">
                        <div class="row">
                ...
                <div class="slide">
                    <img src="{{ asset('media/frontend/images/slider/slide-1.jpg') }}" alt class="slider-bg">
                    <div class="container">
                        <div class="row">
                            <div class="col col-lg-8 col-sm-9 slide-caption">
                                <h2>We provide the best <span>Industrial</span> Services worldwide</h2>
                ...
                <div class="slide">
                    <img src="{{ asset('media/frontend/images/slider/slide-3.jpg') }}" alt class="slider-bg">
                    <div class="container">
                        <div class="row">
                            <div class="col col-lg-8 col-sm-9 slide-caption">
                                <h2>We provide the best <span>Industrial</span> Services worldwide</h2>
                ...
                <div class="row">
                    ...
                    <div class="col col-lg-3 col-md-3">
                       <div class="all-service-link">
                            <a href="{{ url('/our-services') }}" class="theme-btn">All services</a>
                       </div>
                    </div>
                </div> <!-- end row -->
        ...
        <!-- start testimonials -->
        <section class="testimonials section-padding parallax" data-bg-image="{{ asset('media/frontend/images/testimonials/bg.jpg') }}">
            <div class="container">
                <div class="row">
                    <div class="col col-xs-12">
                                ...
                                <div class="inner">
                                    ...
                                    <div class="client-details">
                                        <div class="client-pic">
                                            <img src="{{ asset('media/frontend/images/testimonials/client.jpg') }}" alt>
                                        </div>
                    ...
                    <div class="recent-projects-grids">
                        <div class="grid">
                            <div class="project-img">
                                <img src="{{ asset('media/frontend/images/projects/img-1.jpg') }}" alt>
                            </div>
                        ...
                        <div class="grid">
                            <div class="project-img">
                                <img src="{{ asset('media/frontend/images/projects/img-2.jpg') }}" alt>
                            </div>
                            <div class="project-info">
                                <div class="inner-info">
                                    <a href="#"><h3>Chemical Refinery</h3></a>
                        ...
                        <div class="grid">
                            <div class="project-img">
                                <img src="{{ asset('media/frontend/images/projects/img-3.jpg') }}" alt>
                            </div>
                            <div class="project-info">
                                <div class="inner-info">
                                    <a href="#"><h3>Chemical Refinery</h3></a>
                        ...
                        <div class="grid">
                            <div class="project-img">
                                <img src="{{ asset('media/frontend/images/projects/img-4.jpg') }}" alt>
                            </div>
                            <div class="project-info">
                                <div class="inner-info">
                                    <a href="#"><h3>Chemical Refinery</h3></a>
                        ...
                        <div class="grid">
                            <div class="project-img">
                                <img src="{{ asset('media/frontend/images/projects/img-5.jpg') }}" alt>
                            </div>
                            <div class="project-info">
                                <div class="inner-info">
                                    <a href="#"><h3>Chemical Refinery</h3></a>
        ...
        <section class="section-padding about-us-faq">
            ...
            <div class="backhoe-loader">
                <img src="{{ asset('media/frontend/images/backhoe-loader.png') }}" alt>
            </div>
        </section>
                ...
                <div class="row">
                    <div class="col col-xs-12">
                        <div class="partners-slider">
                            <div class="grid">
                                <img src="{{ asset('media/frontend/images/partners/img-1.png') }}" alt>
                            </div>
                            <div class="grid">
                                <img src="{{ asset('media/frontend/images/partners/img-2.png') }}" alt>
                            </div>
                            <div class="grid">
                                <img src="{{ asset('media/frontend/images/partners/img-3.png') }}" alt>
                            </div>
                            <div class="grid">
                                <img src="{{ asset('media/frontend/images/partners/img-4.png') }}" alt>
                            </div>
                            <div class="grid">
                                <img src="{{ asset('media/frontend/images/partners/img-2.png') }}" alt>
                            </div>
        ...
        <section class="contact-section section-padding parallax" data-bg-image="{{ asset('media/frontend/images/contact-section-bg.jpg') }}">
            <div class="container">
                <div class="row">
            ...
            <div class="contact-women wow fadeInLeft">
                <img src="{{ asset('media/frontend/images/contact-women.png') }}" alt>
            </div>
        </section>
        <!-- end contact-section -->
@endsection