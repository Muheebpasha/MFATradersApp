...
@include('partials.breadcrumb')
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col col-md-7">
                    <div class="offer-pic">
                        <img src="{{ asset('media/frontend/images/offer-pic.jpg') }}" alt>
                    </div>
                </div>
            </div> <!-- end row -->
        </div> <!-- end container -->
    ...
    <!-- start cta -->
    <section class="cta section-padding parallax" data-bg-image="{{ asset('media/frontend/images/cta-bg.jpg') }}">
        <div class="container">
            <div class="row">
                    ...
                    <div class="team-slider team-grids">
                        <div class="team-grid">
                            <div class="member-pic-social square-hover-effect-parent">
                                ...
                                <div class="member-pic">
                                    <img src="{{ asset('media/frontend/images/team/img-1.jpg') }}" alt>
                                </div>
                                <div class="social">
                        ...
                        <div class="team-grid">
                            <div class="member-pic-social square-hover-effect-parent">
                                ...
                                <div class="member-pic">
                                    <img src="{{ asset('media/frontend/images/team/img-2.jpg') }}" alt>
                                </div>
                                <div class="social">
                                    <ul class="social-links">
                                        <li><a href="#"><i class="fa fa-facebook"></i></a></li>
                        ...
                        <div class="team-grid">
                            <div class="member-pic-social square-hover-effect-parent">
                                ...
                                <div class="member-pic">
                                    <img src="{{ asset('media/frontend/images/team/img-3.jpg') }}" alt>
                                </div>
                                <div class="social">
                                    <ul class="social-links">
                                        <li><a href="#"><i class="fa fa-facebook"></i></a></li>
